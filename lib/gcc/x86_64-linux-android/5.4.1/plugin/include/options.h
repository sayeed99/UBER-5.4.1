...
enum opt_code
{
  ...
  OPT_fuse_ld_mcld = 1062,                   /* -fuse-ld=mcld */
  ...
  OPT_mmwaitx = 1218,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1219,            /* -mno-align-stringops */
  OPT_mno_default = 1220,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1221,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1222,                  /* -mno-push-args */
  OPT_mno_red_zone = 1223,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1224,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1225,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1226,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1227,                          /* -mpc32 */
  OPT_mpc64 = 1228,                          /* -mpc64 */
  OPT_mpc80 = 1229,                          /* -mpc80 */
  OPT_mpclmul = 1230,                        /* -mpclmul */
  OPT_mpcommit = 1231,                       /* -mpcommit */
  OPT_mpopcnt = 1232,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1233,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1234,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1235,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1236,                        /* -mprfchw */
  OPT_mpush_args = 1237,                     /* -mpush-args */
  OPT_mrdrnd = 1238,                         /* -mrdrnd */
  OPT_mrdseed = 1239,                        /* -mrdseed */
  OPT_mrecip = 1240,                         /* -mrecip */
  OPT_mrecip_ = 1241,                        /* -mrecip= */
  OPT_mrecord_mcount = 1242,                 /* -mrecord-mcount */
  OPT_mred_zone = 1243,                      /* -mred-zone */
  OPT_mregparm_ = 1244,                      /* -mregparm= */
  OPT_mrtd = 1245,                           /* -mrtd */
  OPT_mrtm = 1246,                           /* -mrtm */
  OPT_msahf = 1247,                          /* -msahf */
  OPT_msha = 1248,                           /* -msha */
  OPT_mskip_rax_setup = 1249,                /* -mskip-rax-setup */
  OPT_msoft_float = 1250,                    /* -msoft-float */
  OPT_msse = 1251,                           /* -msse */
  OPT_msse2 = 1252,                          /* -msse2 */
  OPT_msse2avx = 1253,                       /* -msse2avx */
  OPT_msse3 = 1254,                          /* -msse3 */
  OPT_msse4 = 1255,                          /* -msse4 */
  OPT_msse4_1 = 1256,                        /* -msse4.1 */
  OPT_msse4_2 = 1257,                        /* -msse4.2 */
  OPT_msse4a = 1258,                         /* -msse4a */
  /* OPT_msse5 = 1259, */                    /* -msse5 */
  OPT_msseregparm = 1260,                    /* -msseregparm */
  OPT_mssse3 = 1261,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1262,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1263,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1264,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1265,            /* -mstringop-strategy= */
  OPT_mtbm = 1266,                           /* -mtbm */
  OPT_mtls_dialect_ = 1267,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1268,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1269,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1270,                         /* -mtune= */
  OPT_muclibc = 1271,                        /* -muclibc */
  OPT_mveclibabi_ = 1272,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1273,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1274,                    /* -mvzeroupper */
  OPT_mx32 = 1275,                           /* -mx32 */
  OPT_mxop = 1276,                           /* -mxop */
  OPT_mxsave = 1277,                         /* -mxsave */
  OPT_mxsavec = 1278,                        /* -mxsavec */
  OPT_mxsaveopt = 1279,                      /* -mxsaveopt */
  OPT_mxsaves = 1280,                        /* -mxsaves */
  OPT_n = 1281,                              /* -n */
  OPT_no_canonical_prefixes = 1282,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1283,              /* -no-integrated-cpp */
  OPT_nocpp = 1284,                          /* -nocpp */
  OPT_nodefaultlibs = 1285,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1286,                   /* -nostartfiles */
  OPT_nostdinc = 1287,                       /* -nostdinc */
  OPT_nostdinc__ = 1288,                     /* -nostdinc++ */
  OPT_nostdlib = 1289,                       /* -nostdlib */
  OPT_o = 1290,                              /* -o */
  OPT_p = 1291,                              /* -p */
  OPT_pass_exit_codes = 1292,                /* -pass-exit-codes */
  /* OPT_pedantic = 1293, */                 /* -pedantic */
  OPT_pedantic_errors = 1294,                /* -pedantic-errors */
  OPT_pg = 1295,                             /* -pg */
  OPT_pie = 1296,                            /* -pie */
  OPT_pipe = 1297,                           /* -pipe */
  OPT_posix = 1298,                          /* -posix */
  OPT_print_file_name_ = 1299,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1300,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1301,          /* -print-multi-directory */
  OPT_print_multi_lib = 1302,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1303,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1304,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1305,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1306,               /* -print-prog-name= */
  OPT_print_search_dirs = 1307,              /* -print-search-dirs */
  OPT_print_sysroot = 1308,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1309,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1310,                        /* -profile */
  OPT_pthread = 1311,                        /* -pthread */
  OPT_quiet = 1312,                          /* -quiet */
  OPT_r = 1313,                              /* -r */
  OPT_rdynamic = 1314,                       /* -rdynamic */
  OPT_remap = 1315,                          /* -remap */
  OPT_s = 1316,                              /* -s */
  OPT_s_bc_abi = 1317,                       /* -s-bc-abi */
  OPT_save_temps = 1318,                     /* -save-temps */
  OPT_save_temps_ = 1319,                    /* -save-temps= */
  OPT_shared = 1320,                         /* -shared */
  OPT_shared_libgcc = 1321,                  /* -shared-libgcc */
  /* OPT_specs = 1322, */                    /* -specs */
  OPT_specs_ = 1323,                         /* -specs= */
  OPT_static = 1324,                         /* -static */
  OPT_static_libasan = 1325,                 /* -static-libasan */
  OPT_static_libgcc = 1326,                  /* -static-libgcc */
  OPT_static_libgcj = 1327,                  /* -static-libgcj */
  OPT_static_libgfortran = 1328,             /* -static-libgfortran */
  OPT_static_libgo = 1329,                   /* -static-libgo */
  OPT_static_liblsan = 1330,                 /* -static-liblsan */
  OPT_static_libmpx = 1331,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1332,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1333,               /* -static-libstdc++ */
  OPT_static_libtsan = 1334,                 /* -static-libtsan */
  OPT_static_libubsan = 1335,                /* -static-libubsan */
  /* OPT_std_c__03 = 1336, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1337, */                /* -std=c++0x */
  OPT_std_c__11 = 1338,                      /* -std=c++11 */
  OPT_std_c__14 = 1339,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1340, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1341, */                /* -std=c++1y */
  OPT_std_c__1z = 1342,                      /* -std=c++1z */
  OPT_std_c__98 = 1343,                      /* -std=c++98 */
  OPT_std_c11 = 1344,                        /* -std=c11 */
  /* OPT_std_c1x = 1345, */                  /* -std=c1x */
  /* OPT_std_c89 = 1346, */                  /* -std=c89 */
  OPT_std_c90 = 1347,                        /* -std=c90 */
  OPT_std_c99 = 1348,                        /* -std=c99 */
  /* OPT_std_c9x = 1349, */                  /* -std=c9x */
  OPT_std_f2003 = 1350,                      /* -std=f2003 */
  OPT_std_f2008 = 1351,                      /* -std=f2008 */
  OPT_std_f2008ts = 1352,                    /* -std=f2008ts */
  OPT_std_f95 = 1353,                        /* -std=f95 */
  OPT_std_gnu = 1354,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1355, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1356, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1357,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1358,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1359, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1360, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1361,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1362,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1363,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1364, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1365, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1366,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1367,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1368, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1369, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1370,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1371, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1372, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1373, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1374,                     /* -std=legacy */
  OPT_symbolic = 1375,                       /* -symbolic */
  OPT_t = 1376,                              /* -t */
  OPT_time = 1377,                           /* -time */
  OPT_time_ = 1378,                          /* -time= */
  OPT_tno_android_cc = 1379,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1380,                 /* -tno-android-ld */
  OPT_traditional = 1381,                    /* -traditional */
  OPT_traditional_cpp = 1382,                /* -traditional-cpp */
  OPT_trigraphs = 1383,                      /* -trigraphs */
  OPT_u = 1384,                              /* -u */
  OPT_undef = 1385,                          /* -undef */
  OPT_v = 1386,                              /* -v */
  OPT_version = 1387,                        /* -version */
  OPT_w = 1388,                              /* -w */
  OPT_wrapper = 1389,                        /* -wrapper */
  OPT_x = 1390,                              /* -x */
  OPT_z = 1391,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
